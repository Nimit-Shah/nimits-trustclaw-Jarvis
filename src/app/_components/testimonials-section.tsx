...
const TWEETS: Tweet[] = [
  ...
  },
  {
    ...
    body: "A friend asked me to help him set up OpenClaw over the weekend. 2 hours of Docker, port forwarding, .env files. I said bro just try Nimits-Jarvis. He messages me from Telegram 5 minutes later like \"wait that's it?\" Yes. That's it :)",
    replies: 7,
    retweets: 28,
    likes: 189,
    views: "3.2K",
  ...
  },
  {
    ...
    body: "Nimits-Jarvis >>> OpenClaw for anyone who doesn't want to mass expose their credentials. OAuth only, sandboxed execution, works straight from Telegram. Genuinely don't know why anyone is still self-hosting an AI agent with root access in 2026",
    replies: 31,
    retweets: 156,
    likes: 847,
    views: "38.2K",
